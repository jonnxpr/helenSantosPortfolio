...
description: Shared agent skill for safe-parity Speckit workflow in the HelenSantosPortfolio repository.
---

# Skill - speckit-workflow (HelenSantosPortfolio - Agent)
